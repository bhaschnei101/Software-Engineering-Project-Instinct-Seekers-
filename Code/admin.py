...
fname = StringVar()
lname = StringVar()
hintUser = StringVar(root, name="User Name")
hintPassword = StringVar(root, name="Password")
...
class login_page:
    def __init__(self, top=None):
        ...
        icon_Photo = PhotoImage(file = "./images/Icon_Photo_2.png")
        ...
        self.entry1.place(relx=0.373, rely=0.273, width=384, height=24)
        ...
        top.geometry("1509x626")
        top.title("BIGG BAZAAR")
        top.resizable(0, 0)
        icon_Photo = PhotoImage(file = "./images/Icon_Photo_3.png")
        top.iconphoto(False, icon_Photo)
        
        self.label1 = Label(root)
        self.label1.place(x=0, y=0, width=1509, height=626)
        self.img = PhotoImage(file="./images/LoginPages2.png")
        self.label1.configure(image=self.img)
        
        '''self.label2 = Label(root)
        self.label2.place(x=566, y=200)
        self.label2.configure(text="""UserName""")
        self.label2.configure({"background": "#ffffff"})

        self.label3 = Label(root)
        self.label3.place(x=568, y=300)
        self.label3.configure(text="""Password""")
        self.label3.configure({"background": "#ffffff"})'''

        self.label4 = Label(root)
        self.label4.place(x=660, y=518, width=200, height=18)
        self.label4.configure({"background": "#ffffff"})
        
        self.label5 = Label(root, text='ADMIN', font='Poppins 13 bold italic')
        self.label5.place(x=570, y=106)
        self.label5.configure({"background": "#ffffff"})
        self.label5.configure({"foreground": "#0033cc"})

        self.entry1 = Entry(root)
        self.entry1.place(x=566, y=231, width=369, height=44)
        self.entry1.configure(font="-family {Poppins} -size 10")
        self.entry1.configure(relief="raised")
        self.entry1.configure({"background": "#ffffff"})
        self.entry1.configure(textvariable=user)
        self.entry1.insert(0, hintUser)
        self.entry1.bind("<Button-1>", self.click)

        self.entry2 = Entry(root)
        self.entry2.place(x=568, y=332, width=367, height=43)
        self.entry2.configure(font="-family {Poppins} -size 10")
        self.entry2.configure(relief="raised")
        #self.entry2.configure(show="*")
        self.entry2.configure({"background": "#ffffff"})
        self.entry2.configure(textvariable=passwd)
        self.entry2.insert(0, hintPassword)
        self.entry2.bind("<Button-1>", self.click2)

        self.button1 = Button(root)
        self.button1.place(x=644, y=406, width=214, height=68)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#ff0000")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="White")
        self.button1.configure(background="#ED2553")
        self.button1.configure(font="-family {Poppins SemiBold} -size 20")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""LOGIN""")
        self.button1.configure(command=self.login)
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.message.place(relx=0.046, rely=0.056, width=65, height=30)
