...
class login_page:
    def __init__(self, top=None):
        ...
        self.label1 = Label(root)
        self.label1.place(x=0, y=0, width=360, height=360)
        self.img = PhotoImage(file="./images/sam4.png")
        self.label1.configure(image=self.img)
        
        self.entry1 = Entry(root)
        self.entry1.place(x=105, y=113, width=177, height=34)
        self.entry1.configure(font="-family {Poppins} -size 10")
        self.entry1.configure(relief="flat")
        self.entry1.configure({"background": "#476468"})
        self.entry1.configure(textvariable=user)
        self.entry1.insert(0, hintUser)
        self.entry1.bind("<Button-1>", click)

        self.entry2 = Entry(root)
        self.entry2.place(x=66, y=171, width=177, height=34)
        self.entry2.configure(font="-family {Poppins} -size 10")
        self.entry2.configure(relief="flat")
        #self.entry2.configure(show="*")
        self.entry2.configure({"background": "#476468"})
        self.entry2.configure(textvariable=passwd)
        self.entry2.insert(0, hintPassword)
        self.entry2.bind("<Button-1>", click2)
        
        self.button1 = Button(root)
        self.button1.place(x=65, y=244, width=217, height=38)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#ff0000")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#476468")
        self.button1.configure(font="-family {Poppins SemiBold} -size 20")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""LOGIN""")
        self.button1.configure(command=login)
